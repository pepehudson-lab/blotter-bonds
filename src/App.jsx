              ...
              <div style={{marginBottom:20}}>
                ...
                {calcOpen && (
                  <div style={{
                    ...
                    background:"#faf8f4", padding:"16px",
                  }}>
                    {/* Inputs */}
                    <div style={{display:"grid", gridTemplateColumns:"1fr 1fr 1fr 1fr", gap:10, marginBottom:14}}>
                      ...
                      <div style={{display:"flex", alignItems:"flex-end"}}>
                        <button
                          ...
                          style={{
                            width:"100%", padding:"9px 0", background:"#e8f8ee",
                            border:"1px solid #3ddc84", borderRadius:3,
                            color:"#1a7a3a", fontWeight:700, fontSize:11,
                      ...
                      <div style={{borderTop:"1px solid #1a2a1a", paddingTop:14}}>
                        <div style={{display:"grid", gridTemplateColumns:"1fr 1fr 1fr", gap:10, marginBottom:12}}>
                          {[
                            ...
                            <div key={lbl} style={{background:"#f0ebe2", border:"1px solid #1c2633", borderRadius:4, padding:"10px 12px"}}>
                              <div style={{fontSize:8,color:"#8a7050",letterSpacing:1.5,textTransform:"uppercase",marginBottom:4}}>{lbl}</div>
                        ...
                        <div style={{display:"flex", gap:8}}>
                          ...
                          <button
                            ...
                            style={{flex:1, padding:"7px 0", background:"#e8f8ee", border:"1px solid #3ddc84", borderRadius:3, color:"#1a7a3a", fontSize:10, fontWeight:700, cursor:"pointer", letterSpacing:1}}
